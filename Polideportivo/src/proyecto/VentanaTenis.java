...
public class VentanaTenis extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VentanaTenis(Pista reservas) {
		...
		JLabel lblActividadBaloncesto = new JLabel("Tenis");
