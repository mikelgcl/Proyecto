...
public class VentanaFutbol extends JFrame {
	 ...
	 * Create the frame.
	 */
	public VentanaFutbol(Pista reservas) {
		...
		JLabel lblActividadBaloncesto = new JLabel("Fútbol");
