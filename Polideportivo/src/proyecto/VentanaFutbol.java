...
public class VentanaFutbol extends JFrame {
	...
	public VentanaFutbol() {
		...
		JLabel lblActividadFutbol = new JLabel("Actividad: Futbol");
		lblActividadFutbol.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblActividadFutbol.setBounds(130, 136, 160, 27);
		contentPane.add(lblActividadFutbol);
